...
class BadgeAPI(APIInterface):
    def __init__(self):
        super().__init__(Badge, BadgeSerializer)


class PostAPI(APIInterface):
    def __init__(self):
        super().__init__(Post, PostSerializer)


class DeveloperAPI(APIInterface):
    def __init__(self):
        super().__init__(Developer, DeveloperSerializer)